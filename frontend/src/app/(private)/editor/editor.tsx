                            ...
                            <div className=" bg-white  mx-auto shadow-lg rounded-lg hover:shadow-xl transition duration-200">
                                <div className="py-4 px-8">
                                    ...
                                    <div className="mt-10 relative flex flex-row place-items-center">
                                        <input id="ArticleName" type={'text'} name="password" className="peer h-10 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-sky-600" placeholder="Article name" />
                                        <label htmlFor="ArticleName" className="absolute left-0 -top-3.5 text-gray-600 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Article name</label>
                                    </div>

                                    <div className="max-w-[1000px] relative flex flex-col w-full">
                                        <textarea placeholder="Article abstract" rows={4} className="p-3 mt-8 rounded-xl"></textarea>
                                    </div>

                                    <div className="mt-10 relative flex flex-row place-items-center">
                                        <input id="ArticleLink" type={'text'} name="password" className="peer h-10 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-sky-600" placeholder="Article link" />
                                        <label htmlFor="ArticleLink" className="absolute left-0 -top-3.5 text-gray-600 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Article link</label>
                                    </div>
